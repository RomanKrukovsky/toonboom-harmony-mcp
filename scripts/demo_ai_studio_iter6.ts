...
import { generateCameraLayoutReport } from '../src/adapters/cameraLayoutReport/index.js';
import fs from 'fs';
...
const characters = [
  { characterId: 'masha', name: 'Masha', role: 'protagonist', stance: 'standing' as const, visibleOnScreen: true },
  { characterId: 'ivan', name: 'Ivan', role: 'antagonist', stance: 'standing' as const, visibleOnScreen: true }
];
