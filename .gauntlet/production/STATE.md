...
| 07 | возобновление после аварии | throughput | B | BAR WINS | налог падения печатается как «+-1%» — форматирование отрицательного процента ломается,… |
| 08 | возобновление после аварии | resilience | A | OURS WINS | два прогона на одной серии одновременно не блокируются — оба считают одни шоты, пишут в… |
| 09 | возобновление после аварии | resume | B | OURS WINS | возобновление опирается на журнал + счёт файлов, но НЕ на содержимое описания шота — ес… |
| 10 | возобновление после аварии | assembly | B | OURS WINS | мастер из недосчитанной серии собирается и называет пропущенные шоты в возвращаемом сло… |
