...
export const config = {
    ...
    backends: {
        image: (process.env.HARMONY_BACKEND_IMAGE || 'none'),
        audio: (process.env.HARMONY_BACKEND_AUDIO || 'none'),
        llm: (process.env.HARMONY_BACKEND_LLM || 'none'),
        apiKeys: {
...
export const DEFAULT_MOUTH_SHAPES = ['A', 'E', 'I', 'O', 'U', 'M', 'F', 'L', 'S', 'rest'];
