...
export class EpisodeAssembler {
    generateRenderPlan(episodePlan, cameraPlans, fxPlans) {
        return {
    ...
    assembleScenePlans(episodePlan, characterSpecs, cameraPlans, fxPlans, actingPlans = [], lipsyncPlans = [], backgroundPlans = []) {
        return episodePlan.scenes.map(scene => this.buildScenePlan(scene, episodePlan, characterSpecs, cameraPlans, fxPlans, actingPlans, lipsyncPlans, backgroundPlans));
    }
    buildScenePlan(scene, episodePlan, characterSpecs, cameraPlans, fxPlans, actingPlans = [], lipsyncPlans = [], backgroundPlans = []) {
