...
import { buildHumanoidStandardRigTemplate } from './rigTemplates/humanoidStandardRig.js';
import { ActingPrimitivesEngine } from './actingPrimitives/actingPrimitivesEngine.js';
export class PIRCompiler {
    actingEngine = new ActingPrimitivesEngine();
    compileToHarmonyScene(pir, outputDir) {
    ...
    generateXStageXml(pir, rig, perf) {
