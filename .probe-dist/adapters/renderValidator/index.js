...
export class RenderOutputValidator {
    validate(filePath, expectedRenderer) {
        ...
        if (textHeader.startsWith('SIMULATED_VIDEO_STREAM') ||
        ...
        let isLikelyValidVideo = 'unknown';
        let isLikelyValidImage = 'unknown';
        ...
        let detectedRenderer = expectedRenderer || 'unknown';
