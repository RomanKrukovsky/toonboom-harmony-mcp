...
export declare const bezierSegmentSchema: z.ZodObject<{
...
export declare const widthPointSchema: z.ZodObject<{
...
export declare const drawingStrokePIRSchema: z.ZodObject<{
...
export declare const fillRegionPIRSchema: z.ZodObject<{
...
export declare const coordinateTransformationSchema: z.ZodObject<{
...
export declare const drawingLayerPIRSchema: z.ZodObject<{
    layerId: z.ZodString;
    name: z.ZodString;
...
export declare const characterDrawingPIRSchema: z.ZodObject<{
 ...
 */
export declare function computePIRHash(pir: Omit<CharacterDrawingPIR, 'deterministicHash'>): string;
