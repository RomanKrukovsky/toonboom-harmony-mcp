...
export const uncertaintySchema = z.object({
    level: z.enum(['low', 'medium', 'high', 'critical']).describe('Низкий = вывод механически выведен из письменных маркеров в сценарии. ' +
...
export const dramaticBeatSchema = z.object({
    ...
    intent: z.string().min(1).describe('Глагол драматического намерения (accuse, reveal, hide, seduce, threaten, plead…). ' +
    ...
    importance: z.number().min(0).max(1).describe('Драматический вес: 1.0 = поворотный момент сцены, 0.1 = проходная пауза.'),
