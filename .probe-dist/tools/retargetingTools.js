...
import { RigProfileSchema, JointMappingSchema, RetargetingManifestSchema, } from "../schemas/retargeting.js";
    ...
    defineTool({
        ...
        handler: async (args) => {
            ...
            if (!parsedManifest.success) {
                throw new HarmonyError("INVALID_RECONSTRUCTION_MANIFEST", "Манифест ретаргетинга не прошёл Zod-валидацию.", parsedManifest.error.flatten());
            }
