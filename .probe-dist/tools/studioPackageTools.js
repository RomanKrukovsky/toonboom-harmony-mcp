...
export const studioPackageTools = [
    ...
    defineTool({
        ...
        handler: async (args) => {
            ...
            const charChecklist = charSpecs.map((c) => ({
            ...
            const scenesChecklist = (episode.scenes || []).map((s) => ({
            ...
            const checklist = {
                ...
                overallReadiness: charChecklist.every((c) => c.rigStatus === 'ready') ? '100% Ready' : '75% Briefs Ready'
            };
            if (args.outputDir) {
