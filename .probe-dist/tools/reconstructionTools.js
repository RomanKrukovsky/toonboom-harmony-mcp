...
function checkedVideo(videoPath) {
...
export const reconstructionTools = [
    ...
    defineTool({
        ...
        handler: async (args) => {
            ...
            if (job.status !== 'completed' || !job.manifestPath)
                return job;
    ...
    defineTool({
        ...
        handler: async (args) => {
            ...
            if (args.dryRun === false)
                enforceDestructiveSafety('apply_reconstruction_manifest', args);
            try {
