...
export const mlTools = [
    ...
    defineTool({
        ...
        handler: async (args) => client.installModel(args.modelId)
    }),
    defineTool({
        ...
        handler: async (args) => client.verifyModel(args.modelId)
    }),
    defineTool({
    ...
    defineTool({
        ...
        handler: async (args) => client.segmentVideo(verifyPathAccess(args.videoPath), args.modelId)
    }),
    defineTool({
        ...
        handler: async (args) => client.estimatePose(verifyPathAccess(args.videoPath), args.modelId)
    }),
    defineTool({
        ...
        handler: async (args) => client.trackPoints(verifyPathAccess(args.videoPath), args.queryPoints, args.modelId)
    }),
    defineTool({
        ...
        handler: async (args) => client.transcribeAudio(verifyPathAccess(args.audioPath), args.modelId)
    }),
    defineTool({
        ...
        handler: async (args) => client.perceiveVideo({
            ...args,
    ...
    defineTool({
        ...
        handler: async (args) => client.getJob(args.jobId)
    }),
    defineTool({
        ...
        handler: async (args) => client.cancelJob(args.jobId)
    })
];
