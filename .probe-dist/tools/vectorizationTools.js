...
import { NativeDrawingCompiler } from '../adapters/nativeDrawingCompiler.js';
...
export const vectorizationTools = [
    ...
    defineTool({
        ...
        handler: async (args) => {
            ...
            const commandPlan = NativeDrawingCompiler.compile(pir, args.targetNode, args.targetDrawing, args.targetFrame, 'AUTO');
