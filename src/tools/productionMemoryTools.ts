...
export const productionMemoryTools = [
...

  {
    ...
    handler: async (args: { decision: string; context: string }) => {
      return createStandardExecutionResult({
        status: 'success',
...

  {
    ...
    handler: async (args: { episodeId: string }) => {
      return createStandardExecutionResult({
        status: 'success',
...

  {
    ...
    handler: async (args: { searchTags: string[] }) => {
      return createStandardExecutionResult({
        status: 'success',
...

  {
    ...
    handler: async (args: { motionType: string }) => {
      return createStandardExecutionResult({
        status: 'success',
